...
namespace UnityEngine.XR.Interaction.Toolkit.Inputs
{
    ...
    [BurstCompile]
#endif
    [AddComponentMenu("XR/XR Transform Stabilizer Override", 11)]
    [DefaultExecutionOrder(XRInteractionUpdateOrder.k_TransformStabilizer)]
    public class XRTransformStabilizerOverride : MonoBehaviour
    {
        ...
        protected void Update()
        {
            ...
            if (m_AimTarget == null)
            {
                StabilizeTransform(currentPosition, currentRotation, targetPosition, targetRotation, Time.unscaledDeltaTime, m_PositionStabilization * localScale, m_AngleStabilization,
            ...
            else
            {
                ...
                StabilizePosition(currentPosition, targetPosition, Time.unscaledDeltaTime, m_PositionStabilization * localScale, out var resultPosition);
                ...
                StabilizeOptimalRotation(currentRotation, targetRotation, antiRotation, Time.unscaledDeltaTime, m_AngleStabilization, targetAngleScale, scaleFactor, out var resultRotation);
                m_ThisTransform.SetPositionAndRotation(resultPosition, resultRotation);
            }
        }
