...
public static class BuffDatabase
{
    public static readonly Buff[] AvailableBuffs = new Buff[]
    {
        ...
        new Buff(BuffType.CritChance, "Critical Hit Chance", "Increases the chance of landing a critical hit by {0}.", 0.03f),
        new Buff(BuffType.FireRate, "Rapid Fire", "Increases the rate of fire of your weapon by {0}.", 0.1f),
